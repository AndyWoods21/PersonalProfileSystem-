                        ...
                        <div class="item-list">
                            <c:forEach var="item" items="${requestScope.certificationList}">
                                <div class="item-card">
                                    ...
                                    <p style="color: var(--accent-color); font-weight: 600; font-size: 0.9rem; margin-top: 0.25rem;"><c:out value="${item.issuingOrganization}" /></p>
                                    <p style="color: var(--text-muted); font-size: 0.85rem; margin-top: 0.25rem;">Issued: <c:out value="${item.issueDate}" /></p>
                                    <c:if test="${not empty item.credentialUrl}">
                                        <p style="margin-top: 0.5rem;">
                                            <a href="<c:out value='${item.credentialUrl}' />" target="_blank" style="color: var(--accent-color); font-size: 0.85rem; font-weight: 600; text-decoration: none;">View Credential ↗</a>
                                        </p>
                                    </c:if>
                                </div>
                            </c:forEach>
