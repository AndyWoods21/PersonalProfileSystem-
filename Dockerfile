...
# ENTRYPOINT executes Java with memory limit flags before loading the JAR
ENTRYPOINT ["java", "-Xms128m", "-Xmx384m", "-jar", "/opt/payara/payara-micro.jar"]

# CMD passes the deployment options directly to Payara Micro
