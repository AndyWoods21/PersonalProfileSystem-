                        ...
                        <div class="item-list">
                            <c:forEach var="item" items="${requestScope.educationList}">
                                <div class="item-card">
                                    ...
                                    <p style="color: var(--accent-color); font-size: 0.9rem; font-weight: 600; margin-top: 0.25rem;"><c:out value="${item.institutionName}" /></p>
                                    <p style="color: var(--text-muted); font-size: 0.85rem; margin-top: 0.25rem;"><c:out value="${item.startDate}" /> - <c:out value="${item.endDate}" /></p>
                                </div>
                            </c:forEach>
                        </div>
                    </c:when>
